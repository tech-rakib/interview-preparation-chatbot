...
export default function ServerModal({ visible, onClose, onServerChanged }) {
  ...
  const isCloud = currentUrl === CLOUD_API_URL;
      ...
      <View style={styles.overlay}>
        <View style={[styles.container, { backgroundColor: theme.card, borderColor: theme.border }]}>
          ...
          <Text style={[styles.subtitle, { color: theme.subtext }]}>
            Select where your app connects. Cloud Server works 24/7 even when your PC is turned OFF.
          </Text>
          ...
          >
            <View style={styles.optionHeader}>
              ...
              <View style={{ flex: 1, marginLeft: 10 }}>
                ...
                <Text style={[styles.optionBadge, { color: '#059669' }]}>✓ Works when PC is OFF</Text>
              </View>
          ...
          <TouchableOpacity
            style={[
              styles.optionCard,
              { backgroundColor: !isCloud && currentUrl === getLocalDevURL() ? theme.primaryLight : theme.inputBg, borderColor: !isCloud && currentUrl === getLocalDevURL() ? theme.primary : theme.border },
            ]}
          ...
          >
            <View style={styles.optionHeader}>
              ...
              <View style={{ flex: 1, marginLeft: 10 }}>
                <Text style={[styles.optionTitle, { color: theme.text }]}>💻 Local PC (Wi-Fi)</Text>
                <Text style={[styles.optionUrl, { color: theme.subtext }]}>{getLocalDevURL()}</Text>
                <Text style={[styles.optionBadge, { color: theme.subtext }]}>Requires PC & Wi-Fi</Text>
              </View>
              {!isCloud && currentUrl === getLocalDevURL() && (
